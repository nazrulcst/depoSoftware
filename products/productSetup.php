			...
			<div class="col-sm-10 col-sm-offset-1">
				<div class="col-sm-5">
					<div class="form-group">
						...
						<input type="text" id="proName" name="proName" placeholder="Enter your product name" class="form-control">
					</div>
				</div>
				<div class="col-sm-5">
					<div class="form-group">
						<label for="proPrice">Product Unit Price :</label>
						<input type="number" id="proPrice" name="proPrice" placeholder="Enter your product price" class="form-control">
					</div>
				</div>
				<div class="col-sm-5">
					<div class="form-group">
						<label for="proQuantity">Product Quantity :</label>
						<input type="number" id="proQuantity" name="proQuantity" placeholder="Enter your product quantity" class="form-control">
					</div>
				</div>
				<div class="col-sm-5">
					<div class="form-group">
